...
const promptInputJoin = <HTMLInputElement>(
    promptJoin.querySelector(".prompt__input--join")!
);
const promptInputCreate = <HTMLInputElement>(
    promptCreate.querySelector(".prompt__input--create")!
);

buttonJoin.addEventListener("click", () => {
    promptJoin.classList.toggle("prompt--show");
});

buttonCreate.addEventListener("click", () => {
    promptCreate.classList.toggle("prompt--show");
});
